...
/// <summary>
/// Hidden command used internally to gracefully shut down another process instance from a separate
...
public static class ShutdownInstanceCommand
{
    ...
    {
        var command = new Command("shutdown-instance", "Internal: gracefully shut down a running process instance")
        {
            Hidden = true
        };
